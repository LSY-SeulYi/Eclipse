...
class MyFrame1 ( wx.Frame ):
    ...
    def __init__( self, parent ):
        ...
        self.m_staticText6 = wx.StaticText( self.m_panel3, wx.ID_ANY, u"결과보기 : ", wx.DefaultPosition, wx.DefaultSize, 0 )
